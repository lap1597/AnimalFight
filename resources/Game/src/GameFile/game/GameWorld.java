...
public class GameWorld extends JPanel implements Runnable {
    ...
    public void paintComponent(Graphics g) {
        ...
        buffer.drawImage(this.ground, 0, 0, GameConstants.WORLD_WIDTH, GameConstants.WORLD_HEIGHT, this);
    ...
    private void buildMiniMap(Graphics2D window) {
        double scale = 0.1;
        BufferedImage mini = new BufferedImage((int) (GameConstants.WORLD_WIDTH * scale), (int) (GameConstants.WORLD_HEIGHT * scale), BufferedImage.TYPE_INT_ARGB);
    ...
    private void buildSplitScreen(Graphics window) {
        BufferedImage left = this.world.getSubimage((int) this.t1.getScreenX(), (int) this.t1.getScreenY(), GameConstants.GAME_SCREEN_WIDTH/2, GameConstants.GAME_SCREEN_HEIGHT);
        BufferedImage right = this.world.getSubimage((int) this.t2.getScreenX(), (int) this.t2.getScreenY(), GameConstants.GAME_SCREEN_WIDTH/2, GameConstants.GAME_SCREEN_HEIGHT);

        window.drawImage(left, 0, 0, null);
        window.drawImage(right, GameConstants.GAME_SCREEN_WIDTH/2, 0, null);
    }
